...
public enum ErrorCode {
    ...
    // ===== Weather (US-17) =====
    WEATHER_FETCH_FAILED(HttpStatus.BAD_GATEWAY, "WEATHER_FETCH_FAILED", "날씨 정보를 가져오지 못했습니다"),
    WEATHER_SNAPSHOT_NOT_FOUND(HttpStatus.NOT_FOUND, "WEATHER_SNAPSHOT_NOT_FOUND", "해당 세션의 날씨 정보를 찾을 수 없습니다"),
    WEATHER_SNAPSHOT_ALREADY_EXISTS(HttpStatus.CONFLICT, "WEATHER_SNAPSHOT_ALREADY_EXISTS", "해당 세션에 이미 날씨 정보가 등록되어 있습니다");
